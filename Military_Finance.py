"""
Military Personal Finance — entry point.
...
from ui.panel import (render_save_load, set_household, fmt_money)  # noqa: E402
from engine.profile import Household, ServiceMember, ACTIVE, RETIRED  # noqa: E402
from engine.debt.payoff import Debt  # noqa: E402
from engine.pay import bah as BAH, basepay as BP  # noqa: E402
...
with right:
    st.subheader("What is here")
    st.markdown(
        """
| Page | What it does |
|---|---|
| **Profile** | Who you are, DIEMS, grade, location |
| **Pay** | Basic pay, BAH by ZIP, BAS, taxable split |
| **Career** | Promotions and PCS moves over time |
| **Assets & Debts** | Net worth, including your pension |
| **Debt Payoff** | Avalanche, snowball, SCRA 6% cap |
| **Prime Directive** | Your ordered next actions |
        """
    )
...
with c1:
    ...
    st.caption("A blank plan. Work through the pages from Profile onward.")
